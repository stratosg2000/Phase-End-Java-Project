...
public class FileMagicBusinessService {
	...
	private String businnessFileName;
	private String businnessFullPath;
	...
	public void magicBusinness(Scanner scanner, String operation) {
		...
		System.out.println(" An example of a path in Windows is : C:\\Users\\strat\\eclipse-workspace\\ProjectDir");
		...
		// With the below code the program will check the existence of the provided
		// folder
		...
		if (directoryExists == true) {
			...
			businnessFullPath = businessDirectoryPath + File.separator + businnessFileName;
